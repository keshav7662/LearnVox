...
const CompanionComponent = ({
  companionId, userName, userImage, name,
  subject, topic, style, voice }: CompanionComponentProps) => {
            ...
            <div className={
              cn('absolute transition-opacity duration-1000',
                callStatus === CallStatus.FINISHED || callStatus === CallStatus.INACTIVE ?
                  'opacity-100' : 'opacity-0', callStatus === CallStatus.CONNECTING &&
        ...
        <div className='user-section'>
          ...
          <button className={cn('rounded-lg py-2 cursor-pointer transition-colors w-full text-white',
            ...
            {callStatus === CallStatus.ACTIVE
              ? "End Session" : callStatus === CallStatus.CONNECTING
                ? "Connecting" : "Start Session"
            }
          </button>
        </div>
      </section>
